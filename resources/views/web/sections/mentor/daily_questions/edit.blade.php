...
<div class="row mb-2">
    ...
    <div class="form-group">
        ...
        <textarea class="form-control @error('mentorRemark') is-invalid @enderror"  name="mentorRemark" id="mentorRemark" rows="3">{{ old('mentorRemark', $dailyQuestions->mentor_remark) }}</textarea>
        @error('mentorRemark')
